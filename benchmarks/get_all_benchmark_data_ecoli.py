...
if __name__ == "__main__":
    ...
    print("Usage: python get_all_benchmark_data_ecoli.py <directory_where_benchmark_files> <output_filename> <fmh/mash>")
    ...
    num_genomes_in_files = [1000, 1500, 2000, 2500, 3000, 3682]
    for num_genomes in num_genomes_in_files:
        ...
        sketch_only_filename = f"{directory_where_benchmark_files}/{method_name}_sketch_only_run_{num_genomes}.log"
